  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.textView}>
        ...
        <TextInput style={styles.textInput} placeholder="Data de nascimento" placeholderTextColor="#828282" />
        <TextInput style={styles.textInput} placeholder="Telefone" placeholderTextColor="#828282" />
