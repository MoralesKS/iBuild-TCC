  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.textView}>
        ...
        <TextInput style={styles.textInput} placeholder="Razão social" placeholderTextColor="#828282" />
        <TextInput style={styles.textInput} placeholder="CNPJ" placeholderTextColor="#828282" />
        <TextInput style={styles.textInput} placeholder="Nome do responsável" placeholderTextColor="#828282" />
        <TextInput style={styles.textInput} placeholder="Telefone comercial" placeholderTextColor="#828282" />
        <TextInput style={styles.textInput} placeholder="Email corporativo" placeholderTextColor="#828282" />
